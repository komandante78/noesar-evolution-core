...
test('binary source ingestion stores, extracts, indexes and purges the blob',async()=>{
  ...
  try{
    ...
    const source=await service.ingestFile({projectId:project.id,name:'evidence.txt',mimeType:'text/plain',bytesBase64:bytes.toString('base64')});
