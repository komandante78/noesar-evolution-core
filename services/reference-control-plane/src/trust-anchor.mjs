...
export function renderTrustAnchorIndex(anchor, baseUrl) {
  ...
  lines.push(
    ...
    'It must match the line above character for character. Read that line from the server\'s',
    'own start-up log, or on the host itself with:',
    '',
    `    openssl x509 -in <the file> -noout -fingerprint -sha256`,
    '',
