...
Regenerated by `curve.mjs` at the end of every `run-bench.sh`. Latest run: `outside-01`, 2026-09-12 16:07 UTC.
...
| `outside-01` | 2026-09-12 | `3d01cd89` | 62/155 | 40.0 | 0 | recorded |
...
- `testpenalty-01` -> `outside-01`: **+0** out of 155, same reasoning conditions.
...
6 of 15 runs predate the fingerprint (`baseline`, `after-idf`, `after-onewalk`, `rep1`, `rep2`, `with-model-onewalk`): they are comparable with nothing, and a difference between them would measure the conditions rather than the change.
