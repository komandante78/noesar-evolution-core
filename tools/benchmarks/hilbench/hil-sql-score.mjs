...
let noesarQuestions = 0, noesarDiscovered = 0, degradedTasks = 0, failures = 0, noTrajectory = 0;
...
for (const task of tasks) {
  ...
  console.log(`${task}: questions=${q} discovered=${d}/${log.n_blockers} f1=${mine.toFixed(4)} solve=${reward.solve}${split}`);
}
...
console.log(JSON.stringify({
  ...
  noesarQuestions, noesarDiscovered, degradedTasks, failures, noTrajectory,
