...
CREATE INDEX IF NOT EXISTS noesar_sessions_user_id_idx
  ON noesar_identity.sessions(user_id);
CREATE INDEX IF NOT EXISTS noesar_sessions_expiry_idx
  ON noesar_identity.sessions(expires_at);
